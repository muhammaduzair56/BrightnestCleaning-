 ...
 */
import { ArrowLeft, ArrowRight, CalendarDays, Check, Clock3, Menu, ShieldCheck, X } from "lucide-react";
...
export default function Blog() {
  ...
  return <div className="min-h-screen overflow-x-clip bg-[#f8f6ef] text-[#173137]"><Header mobileOpen={mobileOpen} setMobileOpen={setMobileOpen} />{article ? <ArticleView article={article} /> : <BlogIndex />}<Footer /></div>;
}
