    ...
    <div className="min-h-screen overflow-x-clip bg-[#f8f6ef] text-[#173137]">
      ...
      <header className="sticky top-0 z-40 px-3 pt-3 sm:px-5 lg:px-8">
        <div className="mx-auto flex h-[72px] max-w-[1440px] items-center justify-between gap-5 rounded-full border border-[#173137]/12 bg-[#fffdf7]/95 px-4 shadow-[0_10px_30px_rgba(23,49,55,0.08)] backdrop-blur-xl sm:h-[76px] sm:px-5 lg:px-7">
          ...
          >
            <img
              src="/manus-storage/brightnest-logo-transparent_cf28fbd2.png"
      ...
      <footer className="bg-[#173137] px-5 pb-7 pt-10 text-[#f8f6ef] sm:pt-14 lg:px-10 lg:pt-18">
        <div className="mx-auto grid max-w-[1440px] gap-7 border-b border-white/15 pb-9 sm:gap-10 sm:pb-12 md:grid-cols-[1.25fr_0.75fr_0.75fr]">
          <div>
            <img src="/manus-storage/brightnest-logo-transparent_cf28fbd2.png" alt="BrightNest Cleaning UK logo" className="h-[100px] w-[218px] origin-left scale-[1.08] object-contain object-left" />
